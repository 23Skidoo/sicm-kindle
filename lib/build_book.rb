...
<meta name="dtb:uid" content="BookId"/>
   ...
   <docTitle><text>Structure and Interpretation of Classical Mechanics</text></docTitle>
   <navMap>
...
<package xmlns="http://www.idpf.org/2007/opf" version="2.0" unique-identifier="BookId">
     <metadata xmlns:dc="http://purl.org/dc/elements/1.1/" xmlns:opf="http://www.idpf.org/2007/opf">
          <dc:title>Structure and Interpretation of Classical Mechanics</dc:title>
          <dc:language>en-us</dc:language>
          <dc:identifier id="BookId" opf:scheme="ISBN">0262194554</dc:identifier>
          <dc:creator>Sussman and Wisdom with Meyer</dc:creator>
          <dc:description>Structure and Interpretation of Classical Mechanics</dc:description>
          <dc:subject>Physics -- Mechanics</dc:subject>
